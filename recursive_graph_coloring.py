...
'''
########################GENERATOR METHOD - collect_all_colorings()
...
########################FILTER METHOD - is_a_legal_coloring()
'''
FILTER portion of generate and filter program that determines whether or not a proposed coloring for a graph is legal.
This function takes a list of states and their colors and a list of the states that each borders.
